    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == change) {
            try {
                ...
                Conn conn = new Conn();
                String query1 = "update bank set pin =  '"+rpin+"' where pin = '"+pinnumber1+"' ";
                String query2 = "update login set pin =  '"+rpin+"' where pin = '"+pinnumber1+"' ";
                String query3 = "update signupthree set pin =  '"+rpin+"' where pin = '"+pinnumber1+"' ";
            ...
            setVisible(false);
            new Transactions(pinnumber1).setVisible(true);
        }
    }
